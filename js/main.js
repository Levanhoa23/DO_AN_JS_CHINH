...
function detailProduct(index) {
    ...
    <img class="product-image" src="${infoProduct.img}" >
    </div>
            ...
            <article class="card-product" >
                ...
                <div class="food-info">
                    ...
                    <div class="product-buy">
                        <button onclick="detailProduct(${product.id})" class="card-button order-item"><i class="fa-regular fa-cart-shopping-fast"></i> Mua Hàng </button>
                    </div> 
                </div>
                </div>
            </article>
